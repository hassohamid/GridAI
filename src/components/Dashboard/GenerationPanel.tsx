          ...
          <CardContent className="space-y-4">
              ...
              <TooltipTrigger asChild>
                <div>
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-medium py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                    size="lg"
                  >
              ...
              {!canGenerate && !isGenerating && (
                <TooltipContent>
                  <div className="space-y-1">
                    <p className="font-medium">Upload Required</p>
                    <p className="text-sm">
                      You need exactly 9 photos. Currently: {photos.length}/9
                    </p>
                    <p className="text-xs opacity-75">
                      Upload {9 - photos.length} more photo
                      {9 - photos.length !== 1 ? "s" : ""}
                    </p>
                  </div>
                </TooltipContent>
            ...
            {!isAuthenticated && canGenerate && (
              <p className="text-xs text-muted-foreground text-center">
                All generated feeds are automatically saved to your account for
                download
              </p>
            )}
          </CardContent>
