            ...
            <div className="lg:hidden space-y-8 py-8 overflow-hidden">
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative p-6 rounded-3xl shadow-2xl border-2 border-white/20 bg-gradient-to-br ${feature.bgColor} backdrop-blur-sm w-full max-w-sm transform hover:scale-105 transition-transform`}
                    >
                      <div className="flex items-start gap-4">
                        <div
                          className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-2xl shadow-xl flex-shrink-0`}
                        >
                          {feature.icon}
                        </div>
